...
def load_embedding(embedder_model, custom_embedder=None):
    embedder_root = os.path.join(
        now_dir, "main", "rvc", "engine", "models", "embedders"
    )
    embedding_list = {
    ...
    _embedder_base = "https://huggingface.co/NeoPy/Ultimate-Models/resolve/main/embedders/transformers"
    online_embedders = {
        "contentvec": f"{_embedder_base}/contentvec/pytorch_model.bin",
        "spin": f"{_embedder_base}/spin/pytorch_model.bin",
        "spin-v2": f"{_embedder_base}/spin-v2/pytorch_model.bin",
        "chinese-hubert-base": f"{_embedder_base}/chinese_hubert_base/pytorch_model.bin",
        "japanese-hubert-base": f"{_embedder_base}/japanese_hubert_base/pytorch_model.bin",
        "korean-hubert-base": f"{_embedder_base}/korean_hubert_base/pytorch_model.bin",
    }

    config_files = {
        "contentvec": f"{_embedder_base}/contentvec/config.json",
        "spin": f"{_embedder_base}/spin/config.json",
        "spin-v2": f"{_embedder_base}/spin-v2/config.json",
        "chinese-hubert-base": f"{_embedder_base}/chinese_hubert_base/config.json",
        "japanese-hubert-base": f"{_embedder_base}/japanese_hubert_base/config.json",
        "korean-hubert-base": f"{_embedder_base}/korean_hubert_base/config.json",
    }
