"""
Categorical encoder for speaker labels.

Provides encoding/decoding of speaker labels and checkpoint management.
"""
...
from main.whisper.diarization.speechbrain import if_main_process, ddp_barrier
from main.whisper.diarization.features import register_checkpoint_hooks, mark_as_saver, mark_as_loader
...
class CategoricalEncoder:
    """
    Encoder for categorical speaker labels.
    
    Maps speaker labels to indices and vice versa, with support for
    ...
    def __init__(
        ...
        **special_labels
        ...
        Args:
            starting_index: Starting index for label encoding
            **special_labels: Special labels like 'unk_label'
        """
        self.lab2ind: Dict[str, int] = {}
        self.ind2lab: Dict[int, str] = {}
